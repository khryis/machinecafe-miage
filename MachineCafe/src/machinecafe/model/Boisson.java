...
public class Boisson implements Cloneable{
    ...
    /**
     * Permet d'initialisé la liste des ingrédients possible pour une boisson pour une certaine machine
     * 
    ...
    /**
     * Permet d'insérer un objet Boisson dans la base de données
     * Ceci insère également une ligne dans la table ingredientsBoisson pour chaque ingrédients de la boisson
    ...
    /**
     * Permet de mettre à jour un objet Boisson dans la base de données
     * Ceci met égalementà jour toute les lignes de ingredientsBoisson 
    ...
    /**
     * Permet de Supprimer un objet Boisson dans la base de données (table Boisson)
     * Commence par supprimer toutes les lignes de ingredientsBoisson car dépendance forte avec les clés étrangère
     * @return vrai si la suprresion s'est bien passé, sinon false
     */
